;(function($){
	...
	$.fn.coffee.defaults = {
		steams				: ['jQuery','HTML5','CSS3','$.fn()','var','CODING','THINKING','DREAMING','Python','CoffeeScript','Git','Yoeman','Grunt','Bower','Markdown','Evernote','MongoDB','Redis','MySQL','Tornado','WebPy','Autobahn','Scrapy','Bottle','$.find();','AngularJS','$.ajax()','NodeJS','Sencha','Supervisor','Highcharts','Highstock','Datatables','Bootstrap','Tor','apkTools','UpYun','Jekyll','Pygments','Nose','Mako','Getui','Jasmine','Express' ,'Koa' ,'Passport' ,'AceTemplate' ,'KISSY','SeaJs'], 
